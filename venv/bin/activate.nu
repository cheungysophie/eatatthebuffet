...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/sophie/PycharmProjects/stock-trading-alert/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/sophie/PycharmProjects/stock-trading-alert/venv/bin/deactivate.nu'
